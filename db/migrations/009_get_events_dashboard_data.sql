-- Migration 009: get_events_dashboard_data function
-- This function provides dashboard analytics for the metrics_events table
-- Shows 'Bot' for bot traffic (consistent with get_dashboard_data)
